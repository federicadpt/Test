...
public class LocationHelper {
    ...
    public void start(LocationListener listener) {
        ...
        } else {    // se i permessi non sono stati garantiti dobbiamo lanciare la richiesta dei permessi
            launcher.launch(Manifest.permission.ACCESS_FINE_LOCATION); // dandone uno li do automaticamente entrambi
        }
