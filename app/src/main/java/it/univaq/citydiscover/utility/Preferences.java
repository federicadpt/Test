...
public class Preferences {
    ...
    public static void save(Context context, String key, boolean value){
        ...
        preferences.edit().putBoolean(key,value).apply(); // apply o commit
    }

    public static boolean load(Context context,String key, boolean defValue){
        SharedPreferences preferences= context.getSharedPreferences("myPref",Context.MODE_PRIVATE);
         return preferences.getBoolean(key,defValue); // se non esiste la chiave ritorna il valore di default
    }
}
